...
namespace Prototype.NetworkLobby {
    public class LobbyManager : NetworkLobbyManager {
        static short MsgKicked = UnityEngine.Networking.MsgType.Highest + 1;
        ...
        void Start() {
            ...
            SceneManager.sceneLoaded += CheckForDestruction;


            SetServerInfo("Offline", "None");
        }

        private void CheckForDestruction(Scene arg0, LoadSceneMode arg1) {

            if (SceneManager.GetActiveScene().name == lobbyScene || SceneManager.GetSceneAt(0).name == playScene) {
                DontDestroyOnLoad(gameObject);
            } else {
                SceneManager.sceneLoaded -= CheckForDestruction;
                Destroy(gameObject);
